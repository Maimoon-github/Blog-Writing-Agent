...
This node analyzes the user's topic to determine if web research is needed
and whether the topic is safe to process. It uses a local LLM (Ollama/Mistral)
and falls back to safe defaults if parsing fails.
"""
...
def router_node(state: GraphState) -> Dict[str, Any]:
    ...
    parsed = _parse_response(raw_content, topic=topic)
