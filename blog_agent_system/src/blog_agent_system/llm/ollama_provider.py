"""
Ollama local LLM provider — the only provider used in this project.
"""
...
class OllamaProvider(LLMProvider):
    """Ollama provider for all agents."""

    def __init__(self, model: str = "mistral", temperature: float = 0.7, max_tokens: int = 4096):
